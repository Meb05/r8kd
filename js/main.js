$(document).ready(function() {
	...
	var sliderResource2 = $( "<div id='slider-resource-2'></div>" ).insertAfter( selectResource2 ).slider({
		...
		change: function(event, ui) {
				...
				$('#resource-2-amount').html(sliderValueResource2);
					...
					else if (sliderValueResource2 == '700000') {
					...
					else if (sliderValueResource2 == '900000') {
						progressBarResource2(90, $('#progressBarResource2'));
						$('#increase-resource-2').addClass('btn-disabled');
					}
					else if (sliderValueResource2 == '1000000') {
	...
	$('#second-step-button').click(function() {
		...
		progressBar(0, $('#progressBarConsole'));
		$('.message-header h3').html("ROBLOX Generator");
		$('.message-header p.message-header-subtitle').html("You are about to generate");
		$(".message-content p.console-message").fadeIn();
		var $console_message_username_msg = $('#coc-player-tag').val();
		var $console_message_platform_msg = $('#coc-player-platform').val();
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Adding <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> robux to <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> robux Added Successfully"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Coins Added Successfully"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Coins himself haha');
